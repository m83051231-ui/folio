      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Fondée par HERINIAINA Willy Jacquino, SW DEV est une société de services informatiques basée à Madagascar,
            dédiée à la création de solutions web innovantes et performantes.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16 max-w-6xl mx-auto">
          <div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Accompagner les entreprises et entrepreneurs dans leur transformation digitale en fournissant
              des solutions web de qualité supérieure, innovantes et accessibles.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              Nous croyons que chaque projet a le potentiel de faire une différence. Notre approche est centrée
              sur la création de valeur réelle pour nos clients, en les aidant à atteindre leurs objectifs
              commerciaux à travers des technologies web intelligentes.
            </p>
          ...
          <div>
            ...
            <div className="mt-10 bg-gradient-to-br from-[rgb(240,45,58)] to-[rgb(220,35,48)] p-8 rounded-xl text-white">
              <h4 className="text-xl font-bold mb-3">Prêt à Démarrer ?</h4>
              <p className="mb-6">
                Discutons de votre projet et découvrez comment nous pouvons vous aider à transformer
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Nous écoutons vos besoins et analysons vos objectifs pour proposer la meilleure solution.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Nous créons des solutions innovantes et performantes adaptées à votre contexte.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Livraison impeccable avec support continu pour assurer votre succès.
              </p>
            </div>
          </div>
        </div>
